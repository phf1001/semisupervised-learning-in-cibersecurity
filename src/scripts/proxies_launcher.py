...
if __name__ == '__main__':
    ...
    try:
        ...
        while len(available_proxies) < n_desired_proxies:
            ...
            workers = [Process(target=proxy.launch_file, args=())
            ...
            new_available_proxies = [
                {'http': f'socks5h://127.0.0.1:{proxy.socks_port}'} for proxy in proxies]
            new_available_proxies = [proxy for ip, proxy in zip(
                new_available_ips, new_available_proxies) if ip != '']
