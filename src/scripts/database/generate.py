...
# Modify with heroku credentials if needed
...
def insert_users(connection):
    ...
    try:
        ...
        # Change the values of the credentials before execution
        # Warning! DO NOT upload them to GitHub
        records_to_insert = [
            (
                "patriciahf",
                "phf1001@alu.ubu.es",
