...
\begin{itemize}
	...
	\begin{figure}[h]
		\caption[Métricas: curva ROC]{Calidad del clasificador en función de su curva ROC. Extraída de \url{https://ca.wikipedia.org/wiki/Fitxer:Roc_curve.svg}}
		\label{img:curva_roc}
		\centering
...
\begin{figure}[h]
	\caption[Técnicas: validación cruzada]{Proceso de validación cruzada. Extraída de \url{https://es.wikipedia.org/wiki/Validacion_cruzada}}
	\label{img:val_cruz}
	\centering
