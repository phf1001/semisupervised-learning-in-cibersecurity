...
\begin{itemize}
	...
	\begin{figure}[h]
		\caption[Curva ROC]{Calidad del clasificador en función de su curva \textit{ROC}. Extraída de \url{https://ca.wikipedia.org/wiki/Fitxer:Roc_curve.svg}}
		\label{img:curva_roc}
		\centering
...
Un ataque web es aquel en el que el atacante controla el sitio visitado (por ejemplo: \url{www.atacante.com})~\cite{apuntesCybersec}. Otro factor a tener en cuenta es que se pueden explotar las vulnerabilidades de los navegadores para atacar. Algunos de los escenarios más comunes se mencionan a continuación:
...
\end{figure}
	...
	\begin{figure}[h]
		\caption[Ataques web: XSS]{Infografía de los tipos de ataque XSS existentes: reflejado y almacenado.}
		\label{img:xss}
		\centering
