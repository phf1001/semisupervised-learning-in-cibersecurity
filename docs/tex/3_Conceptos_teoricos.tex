...
\section{Protocolos de red y Tor}

Tor (cuyas silas en inglés significan <<\textit{the onion router}>>) es un protocolo que pretende que el encaminamiento de mensajes no revele la identidad del usuario (e)
