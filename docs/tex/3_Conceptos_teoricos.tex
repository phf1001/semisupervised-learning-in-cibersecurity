...
Hasta el momento, se ha expuesto información relacionada con clasificadores únicos. Es decir, a la hora de predecir una etiqueta (o valor), se tiene en cuenta el \textit{output} de un único estimador base. Sin embargo, en muchas ocasiones, puede resultar enriquecedor recurrir a lo estimado por más de un modelo~\cite{ensembles2006robi}. 
...
Para lograr un mayor nivel de diversidad, se pueden utilizar procedimientos de muestreo o selección de parámetros. En función de ellos, los \textit{ensembles} pueden ser:
