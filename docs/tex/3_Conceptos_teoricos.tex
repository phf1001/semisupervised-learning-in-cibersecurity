...
\begin{figure}[h]
	\caption[\textit{Ensembles}: entrenamiento en \textit{bagging} y \textit{boosting}]{Diferencias esquemáticas entre el entrenamiento en \textit{bagging} (izquierda) y \textit{boosting} (derecha).}
	\label{img:bagging}
	\centering
