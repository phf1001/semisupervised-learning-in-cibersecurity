...
\begin{itemize}
	...
	El número total de horas dedicadas al proyecto fue de $20$. Como algunos de los \textit{issues} requirieron algo menos de tiempo del planificado (en especial los relacionados con la documentación), se destinó el tiempo sobrante a otros pendientes. Aunque se <<dejó abierto>> el \textit{sprint} hasta el 8 de Enero, la intención era acabarlo el 4 de Enero, por lo que la estimación temporal fue correcta.
