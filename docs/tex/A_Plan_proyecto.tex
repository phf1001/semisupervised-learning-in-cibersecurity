...
\begin{figure}[h]
	\caption[Resumen del ciclo de \textit{Scrum}]{Resumen del ciclo de \textit{Scrum} según el Manual de \textit{Scrum}~\cite{scrumMaster2022}.}
...
\begin{figure}[h]
	\caption[Eventos de \textit{Scrum}]{Eventos de \textit{scrum} según el Manual de \textit{scrum}~\cite{scrumMaster2022}.}
...
\begin{itemize}
	...
	\begin{enumerate}
		\item Lectura de aplicación del semisupervisado a la intrusión de redes: lectura del paper de \textit{BigFlow} y su mejora semisupervisada. Investigación de la base de datos.
	...
	El \textit{sprint} se desarrolló entre el 9 y el 20 de enero. Fueron dedicadas al \textit{sprint} 9 horas de trabajo. No se incluye un \textit{burndown report} debido a que no se asociaron las horas de investigación a ningún proyecto en concreto.
...
\begin{itemize}
	\item \textbf{\textit{Planning meeting}}
	\begin{enumerate}
		\item Extracción de vector de características (\textit{phishing}) 3h.
		\item
		\item
		\item 
	\end{enumerate}
