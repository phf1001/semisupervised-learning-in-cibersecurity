...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item Correcciones de documentación: principalmente repeticiones de gráficas ajustando ejes y etiquetas, además de otras anotaciones indicadas.
		\item Viabilidad económica y legal: realizar y documentar el análisis del proyecto.
		\item Manual del programador: escribir la documentación técnica.
		\item Depuración: corrección de defectos encontrados en la \textit{web} por parte del tutor. Mejorar la traducción. Solucionar problema de Docker en Linux Mint.
		\item Calidad: solución de \textit{code smells}.
		\item Documentación: completar apartados pendientes (\textit{abstract}, \textit{keywords}, mejorar la introducción, etc.).
