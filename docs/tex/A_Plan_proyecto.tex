...
\begin{itemize}
	...
	\item \textbf{\textit{Burndown Report}}
		\begin{figure}[h]
			...
			\centering
			\includegraphics[width=\textwidth]{../img/anexos/s06_bdr}
		\end{figure}
