...
\begin{equation}\label{eqn:sueldo-patri} \frac{903.2\frac{\text{€}}{mes}}{1 - (0\text{.}236 + 0\text{.}055 + 0\text{.}002 + 0\text{.}006 + 0\text{.}0150)} = 1316\text{.}62 \frac{\text{€}}{mes}\end{equation}
