...
Es destacable que se ha establecido la equivalencia de un punto de historia a una hora real.
...
\begin{itemize}
	...
	En este \textit{sprint} se ha logrado cerrar todos los \textit{issues} pendientes, habiendo hecho una estimación correcta del tiempo requerido. Se calculó que se iban a invertir 41 horas, cuando el tiempo real ha sido de 4...
...
\begin{equation}\label{eqn:sueldo-patri} \frac{903\text{.}2\frac{\text{€}}{mes}}{1 - (0\text{.}236 + 0\text{.}055 + 0\text{.}002 + 0\text{.}006 + 0\text{.}0150)} = 1316\text{.}62 \frac{\text{€}}{mes}\end{equation}
