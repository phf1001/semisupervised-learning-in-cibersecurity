...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item Depuración: corrección de defectos encontrados en la \textit{web} por parte del tutor. Mejorar la traducción. Solucionar problema de Docker en Linux Mint (SSL y certificados). Arreglar aspectos relacionados con la concurrencia con Gunicorn. Mejorar la sección de ayuda.
