...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item Despliegue: despliegue en Heroku y gestión de errores. Levantar tanto la \textit{web} como el servidor de bases de datos.
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item Documentación: corregir aspectos previos y realizar anexos. Introducir sección de CD/CI y complementar las herramientas (Travis, Heroku). Planificación temporal del \textit{sprint}.
	...
	En este \textit{sprint} todos los \textit{issues} fueron cerrados. Se estimó un tiempo total de trabajo de 29 horas y coincide con el tiempo real dedicado. Cabe destacar que los \textit{issues} de realización de \textit{mockups} requirieron menos tiempo del estimado y que el tiempo sobrante se empleó en seguir programando la página \textit{web}.
