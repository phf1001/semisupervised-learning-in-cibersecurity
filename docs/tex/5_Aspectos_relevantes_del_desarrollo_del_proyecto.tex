...
\begin{table}
	\begin{centering}
		\begin{tabular}{@{} p{9em} p{7em} p{3em} p{3em} p{3em} p{3em} @{}}
			...
			\textit{Bandwagon attack} &- & \hfil 10 & \hfil 10 & \hfil 10 & \hfil0.83 \\
			\\ \bottomrule
		\end{tabular}
	\end{centering}
...
Quiero ver como queda en el índice y hay que escribir algo :)
