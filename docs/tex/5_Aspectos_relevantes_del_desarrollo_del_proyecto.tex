...
\begin{figure}[h]
	...
	\centering
	\includegraphics[scale=0.5]{../img/memoria/5_phishing/f1f19_evolution_acc}
	\label{gr:ph-f1f19_sl-ssl-acc}
\end{figure}

En la gráfica~\ref{gr:ph-f1f19_sl-ssl-acc} se muestra la evolución de la \textit{accuracy} en función del número de etiquetas utilizadas durante la fase de entrenamiento. Como se puede observar, el clasificador que mejor desempeño presenta en general es el \textit{co-forest} de 20 árboles.

\begin{figure}[h]
	\caption[\textit{Phishing}: comparativa SL contra SSL (\textit{accuracy})]{Evolución de la \textit{accuracy} para distintos \textit{ensembles} en función del porcentaje de etiquetas.}
	\centering
	\includegraphics[width=\textwidth]{../img/memoria/5_phishing/f1f19_evolution_rec}
...
\begin{figure}[h]
	\caption[\textit{Phishing}: comparativa SL contra SSL (\textit{accuracy})]{Evolución de la \textit{accuracy} para distintos \textit{ensembles} en función del porcentaje de etiquetas.}
	\centering
	\includegraphics[width=\textwidth]{../img/memoria/5_phishing/f1f19_evolution_prec}
...
\begin{figure}[h]
	\caption[\textit{Phishing}: comparativa SL contra SSL (\textit{accuracy})]{Evolución de la \textit{accuracy} para distintos \textit{ensembles} en función del porcentaje de etiquetas.}
	\centering
	\includegraphics[width=\textwidth]{../img/memoria/5_phishing/f1f19_evolution_f1}
